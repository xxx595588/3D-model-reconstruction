...
imprefixL_obj, imprefixR_obj = 'teapot/grab_0_u/color_C0_', 'teapot/grab_0_u/color_C1_'
imprefixL, imprefixR = 'teapot/grab_0_u/frame_C0_', 'teapot/grab_0_u/frame_C1_' 
...
print("Processing grab`1`")
imprefixL_obj, imprefixR_obj = 'teapot/grab_1_u/color_C0_', 'teapot/grab_1_u/color_C1_'
imprefixL, imprefixR = 'teapot/grab_1_u/frame_C0_', 'teapot/grab_1_u/frame_C1_' 
pts2L,pts2R,pts3,color_value = reconstruct(imprefixL,imprefixR,threshold,imprefixL_obj,imprefixR_obj,threshold_obj,camL,camR)
...
imprefixL_obj, imprefixR_obj = 'teapot/grab_2_u/color_C0_', 'teapot/grab_2_u/color_C1_'
imprefixL, imprefixR = 'teapot/grab_2_u/frame_C0_', 'teapot/grab_2_u/frame_C1_' 
pts2L,pts2R,pts3,color_value = reconstruct(imprefixL,imprefixR,threshold,imprefixL_obj,imprefixR_obj,threshold_obj,camL,camR)
pts3,tri,bvalues=mesh(pts2L,pts2R,pts3,boxlimit,step,color_value,trithresh)
...
imprefixL_obj, imprefixR_obj = 'teapot/grab_3_u/color_C0_', 'teapot/grab_3_u/color_C1_'
imprefixL,imprefixR  = 'teapot/grab_3_u/frame_C0_', 'teapot/grab_3_u/frame_C1_' 
pts2L,pts2R,pts3,color_value = reconstruct(imprefixL,imprefixR,threshold,imprefixL_obj,imprefixR_obj,threshold_obj,camL,camR)
pts3,tri,bvalues=mesh(pts2L,pts2R,pts3,boxlimit,step,color_value,trithresh)
...
imprefixL_obj, imprefixR_obj = 'teapot/grab_4_u/color_C0_', 'teapot/grab_4_u/color_C1_'
imprefixL, imprefixR = 'teapot/grab_4_u/frame_C0_', 'teapot/grab_4_u/frame_C1_'
pts2L,pts2R,pts3,color_value = reconstruct(imprefixL,imprefixR,threshold,imprefixL_obj,imprefixR_obj,threshold_obj,camL,camR)
pts3,tri,bvalues=mesh(pts2L,pts2R,pts3,boxlimit,step,color_value,trithresh)
...
imprefixL_obj, imprefixR_obj = 'teapot/grab_5_u/color_C0_', 'teapot/grab_5_u/color_C1_'
imprefixL, imprefixR = 'teapot/grab_5_u/frame_C0_', 'teapot/grab_5_u/frame_C1_' 
pts2L,pts2R,pts3,color_value = reconstruct(imprefixL,imprefixR,threshold,imprefixL_obj,imprefixR_obj,threshold_obj,camL,camR)
pts3,tri,bvalues=mesh(pts2L,pts2R,pts3,boxlimit,step,color_value,trithresh)
meshutils.writeply(pts3,bvalues,tri,'grab5.ply')

print("Processing grab6")
imprefixL_obj, imprefixR_obj = 'teapot/grab_6_u/color_C0_', 'teapot/grab_6_u/color_C1_'
imprefixL, imprefixR = 'teapot/grab_6_u/frame_C0_', 'teapot/grab_6_u/frame_C1_' 
pts2L,pts2R,pts3,color_value = reconstruct(imprefixL,imprefixR,threshold,imprefixL_obj,imprefixR_obj,threshold_obj,camL,camR)
pts3,tri,bvalues=mesh(pts2L,pts2R,pts3,boxlimit,step,color_value,trithresh)
